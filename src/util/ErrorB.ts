...
export default class ErrorB {
    ...
    public static EMAIL_INVALID: string =         '{"code":"205","msg":"The email address is invalid"}';

    public static PASSWORD_MISSING: string =      '{"code":"206","msg":"Missing password"}';

    public static PASSWORD_INVALID: string =       '{"code":"207","msg":"Missing password"}';
